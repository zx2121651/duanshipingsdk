...
@objc public class FilterEngine: NSObject {
    ...
    // Call on GL thread
    @objc public func initialize(context: EAGLContext?, backend: Int32 = 0) -> Int32 {
        self.context = context
        return wrapper.initialize(with: context, backend: backend)
    }
    ...
    // Clear pipeline
    @objc public func removeAllFilters() -> Int32 {
        return wrapper.removeAllFilters()
    }
